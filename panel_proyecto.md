...
- [ ] Empezar a **rellenar fichas** de los juegos favoritos del autor. 🟡 En marcha: **10 juegos** en el catálogo (`juegos.json`).
...
- **Estado por juego (los 9 completos):**
  ...
  - **Nombre aún en inglés, pendiente de que el autor lo confirme desde su cuenta:** Dark Souls III, Elden Ring, Lords of the Fallen, Bloodborne, Sekiro, Astro's Playroom, **Star Wars Outlaws** (nombres sacados de psn100.net en inglés; el autor aún no lo ha platinado). (El seguimiento de este pendiente vive solo aquí, en el panel — ya no se anota dentro de `juegos.json`, para no filtrar notas internas a los visitantes de la web.)
...
- **Completado en 9 de los 10 juegos del catálogo.** Dark Souls Remastered, Dark Souls II, Sekiro, Bloodborne, Elden Ring, Lords of the Fallen y Demon's Souls con un vídeo de **GameInTheHole** cada uno; Dark Souls III con **dos** vídeos (GameInTheHole + **Acre**); Astro's Playroom con un vídeo de **GPAP360**. Confirmado en producción (`platinoradar.com`). Falta **Star Wars Outlaws** (decisión explícita del autor de dejarlo sin guía por ahora).
