...
- [ ] Empezar a **rellenar fichas** de los juegos favoritos del autor. 🟡 En marcha: **15 juegos** en el catálogo (`juegos.json`).
...
- **Estado por juego (los 9 completos):**
  ...
  - **Nombre aún en inglés, pendiente de que el autor lo confirme desde su cuenta:** Dark Souls III, Elden Ring, Lords of the Fallen, Bloodborne, Sekiro, Astro's Playroom, **Star Wars Outlaws**, **Resident Evil 2 Remake, Resident Evil 3 Remake, Resident Evil 4 Remake, Ghost of Tsushima, Resident Evil Requiem** (nombres sacados de psn100.net en inglés). (El seguimiento de este pendiente vive solo aquí, en el panel — ya no se anota dentro de `juegos.json`, para no filtrar notas internas a los visitantes de la web.)
...
- **Completado en 9 de los 15 juegos del catálogo.** Dark Souls Remastered, Dark Souls II, Sekiro, Bloodborne, Elden Ring, Lords of the Fallen y Demon's Souls con un vídeo de **GameInTheHole** cada uno; Dark Souls III con **dos** vídeos (GameInTheHole + **Acre**); Astro's Playroom con un vídeo de **GPAP360**. Confirmado en producción (`platinoradar.com`). Faltan **Star Wars Outlaws, Resident Evil 2 Remake, Resident Evil 3 Remake, Resident Evil 4 Remake, Ghost of Tsushima y Resident Evil Requiem** (decisión explícita del autor de dejarlos sin guía por ahora).
